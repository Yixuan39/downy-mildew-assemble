...
| `code/qc-other-genomes.sh` | `workflow/05-assembly-qc/qc-other-genomes.sh` |
...
| `code/hard_mask-others.sh` | `workflow/07-repeatmask-gene-prediction/hard-mask-other-genomes.sh` |
| `code/helixer-contigs.sh` | `workflow/07-repeatmask-gene-prediction/helixer-contigs.sh` |
| `code/helixer-others.sh` | `workflow/07-repeatmask-gene-prediction/helixer-other-genomes.sh` |
