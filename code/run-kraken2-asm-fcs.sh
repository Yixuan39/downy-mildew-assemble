...
OUTPUT_DIR=$HOME/project_data/downy/result/kraken2-asm-fcs/oomycota-genomic/${CS}
mkdir -p $OUTPUT_DIR
...
OUTPUT_DIR=$HOME/project_data/downy/result/kraken2-asm-fcs/contam-genomic/${CS}
mkdir -p $OUTPUT_DIR
for FILE in ${FILES[@]}; do
    bash kraken2-asm-fcs.sh \
      -i $FILE \
...
OUTPUT_DIR=$HOME/project_data/downy/result/kraken2-asm-fcs/oomycota-protein/${CS}
mkdir -p $OUTPUT_DIR
for FILE in ${FILES[@]}; do
    bash kraken2-asm-fcs.sh \
      -i $FILE \
...
OUTPUT_DIR=$HOME/project_data/downy/result/kraken2-asm-fcs/contam-protein/${CS}
mkdir -p $OUTPUT_DIR
for FILE in ${FILES[@]}; do
    bash kraken2-asm-fcs.sh \
      -i $FILE \
