...
REF_FILE="/data/run/yyang/project_data/downy/diamond/oomycete.dmnd"
threads=32
...
for INPUT_FILE in "${FILES[@]}"; do
    ...
    diamond blastx \
        ...
        --out ${WORK_PATH}/project_data/downy/diamond/${REF_FILE}/${INPUT_FILE}.csv \
        --al ${WORK_PATH}/project_data/downy/diamond/${REF_FILE}/${INPUT_FILE}.fasta \
        --evalue 1e-10 \
        --max-target-seqs 1 \
        --max-hsps 1 \
        --very-sensitive \
    ...
    busco -i ${WORK_PATH}/project_data/downy/diamond/${REF_FILE}/${INPUT_FILE}.fasta \
        --out_path ${WORK_PATH}/project_data/downy/diamond/${REF_FILE}/${INPUT_FILE}_busco \
        --mode genome \
        --auto-lineage-euk \
    ...
    # run quast
    quast.py --output-dir ${WORK_PATH}/project_data/downy/diamond/${REF_FILE}/${INPUT_FILE}_quast \
        --threads ${threads} \
        --eukaryote \
        ${WORK_PATH}/project_data/downy/diamond/${REF_FILE}/${INPUT_FILE}.fasta
