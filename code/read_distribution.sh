...
# FCS
seqkit fx2tab \
    $HOME/project_data/downy/result/verification/genomic/0.05/SRR15142133.fcs.fasta.gz \
    -n -l -j 32 \
    -o $HOME/project_data/downy/GSL_Data/length/fcs/SRR15142133.tsv.gz

    
# FCS->Kraken2
seqkit fx2tab \
    $HOME/project_data/downy/result/verification/genomic/0.05/SRR15142133.kraken.fasta.gz \
    -n -l -j 32 \
    -o $HOME/project_data/downy/GSL_Data/length/kraken/SRR15142133.tsv.gz
