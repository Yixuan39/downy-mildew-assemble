...
INPUT_DIR="$HOME/project_data/downy/flye/fcs-gx/kraken2/rag_tag/gapless-raw"
# support genome for patching
INPUT_DIR2="$HOME/project_data/downy/hifiasm/fcs-gx/kraken2/purge_dups/rag_tag/gapless-raw"
RESULT_DIR="$HOME/project_data/downy/patch2flye"
