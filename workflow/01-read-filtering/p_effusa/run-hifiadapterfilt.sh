...
# Inputs  : $HOME/project_data/downy/p_effusa/*.fastq.gz
# Outputs : $HOME/project_data/downy/p_effusa/filtered/*.filt.fastq.gz
# Runs on : NCSU BRC (SLURM), single job, 32 cores
# Usage   : sbatch workflow/01-read-filtering/p_effusa/run-hifiadapterfilt.sh
# ----------------------------------------------------------------------------------------
