...
#           method generalises.
# Inputs  : $HOME/project_data/downy/p_effusa/filtered/p_effusa.fastq.gz; FCS-GX at $HOME/db/fcs-gx;
#           compleasm lineages at $HOME/db/compleasm
# Outputs : $HOME/project_data/downy/Assembly/p_effusa/
# Runs on : NCSU BRC login node - the pipeline submits its own SLURM jobs
# Usage   : bash workflow/02-assembly/assemble-p_effusa.sh
# ----------------------------------------------------------------------------------------
set -euo pipefail
