...
| Table 1 | Assembly statistics for the mitochondrial-filtered nuclear assemblies | `workflow/05-assembly-qc/qc-final-assemblies.sh` | `analysis/final_result.Rmd` | - (computed on the cluster QC output, not committed) | `figures/final-assembly-top-contigs.* (companion)` |
